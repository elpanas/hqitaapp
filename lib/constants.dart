...
// Player Container - Player Title - Player Subtitle - Player Field
const kPlayerTextStyle = TextStyle(
  color: Color(0x99FFFFFF),
  fontWeight: FontWeight.bold,
);
const kPlayerMargin = EdgeInsets.symmetric(
  horizontal: 10.0,
  vertical: 10.0,
);
const kPlayerTitlePadding = EdgeInsets.symmetric(vertical: 50.0);
final kPlayerTitleDecoration = BoxDecoration(
  color: const Color(0xFF232329),
  boxShadow: const [BoxShadow(blurRadius: 3.0)],
  borderRadius: BorderRadius.circular(10.0),
);
final kPlayerOpacTextStyle = TextStyle(
...
const kPlayerCardLeadingIcon = Icon(
  Icons.beach_access,
  color: Color(0xFF4CAF50),
);
const kPlayerCardMargin = EdgeInsets.symmetric(
  horizontal: 10.0,
  vertical: 4.0,
);
